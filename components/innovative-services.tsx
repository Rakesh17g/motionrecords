...
import { Instagram, Youtube, Shield, CheckCircle, DollarSign, ArrowRight } from "lucide-react"
                      ...
                      >
                        <div className="bg-gray-800 rounded-lg p-3 h-full">
                          <div className="flex justify-between items-center mb-3">
                            ...
                            <div className="flex space-x-2">
                              {[
                                ...
                                { delay: 0.6, bg: "bg-yellow-400", icon: "👻", textColor: "text-black text-xs" },
                              ].map((platform, i) => (
                                <motion.div
                                  key={i}
                          ...
                          <div className="space-y-1 mb-3">
                            {[
                              { name: "Facebook", color: "bg-blue-600", width: "85%" },
                              { name: "Instagram", color: "bg-pink-600", width: "92%" },
                              { name: "TikTok", color: "bg-black", width: "78%" },
                              { name: "Snapchat", color: "bg-yellow-400 text-black", width: "65%" },
                            ].map((platform, i) => (
                              <motion.div
                                key={i}
                                className={`text-white text-xs px-2 py-1 rounded ${platform.color}`}
                                initial={{ width: "0%" }}
                ...
                <div className="flex flex-col justify-between h-auto">
                  ...
                  <div className="mt-4 flex justify-end">
                    <Link href={`/services#${service.anchor}`}>
                      <AnimatedButton className="bg-white text-black hover:bg-gray-100 px-4 py-2 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.slice(2, 5).map((service, index) => (
              ...
              >
                <div className="aspect-video bg-gray-900 rounded-lg mb-6 overflow-hidden relative border border-gray-800">
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 p-4">
                    {/* Email/SMS Mockup - More Contained */}
                      ...
                      >
                        <div className="bg-gray-800 rounded-lg p-3 h-full">
                          <div className="flex justify-between items-center mb-3">
                            ...
                            <div className="text-xs text-green-400">Sending...</div>
                          </div>
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="text-xs text-gray-300">SMS</div>
                            </div>
                          </div>
                        </div>
                      </motion.div>
                        ...
                        <div className="bg-gray-800 rounded-lg p-3 h-full">
                          ...
                          <div className="bg-gray-700 rounded p-2">
                            ...
                            <div className="space-y-1 mt-1">
                              <div className="bg-red-600 h-1 w-full rounded"></div>
                              <div className="bg-red-600 h-1 w-2/3 rounded"></div>
                            </div>
                          </div>
                        </div>
                      </motion.div>
